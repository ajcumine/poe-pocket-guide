...
const actFour: Step = {
  1: { description: 'Enter The Dried Lake.' },
  2: {
    description:
  ...
  4: {
    description: 'Proceed through the area and enter The Mines (Level Two).',
  },
  5: { description: 'Locate Deshret’s Spirit and release it.' },
  6: { description: 'Enter the Crystal Veins.' },
  7: {
    description:
  ...
  9: { description: 'Return to the Crystal Veins via the Waypoint.' },
  10: {
    description:
  ...
  17: { description: 'Enter the Bowels of the Beast.' },
  18: { description: 'Defeat Piety.' },
  19: {
    description:
  ...
  21: { description: 'Return to The Harvest.' },
  22: {
    description:
      'Slay Malachai’s 3 guardians; Doedre, Maligaro, and Shavronne. Pick up the various organs they drop.',
  },
  23: { description: 'Enter The Black Core, found next to the Waypoint.' },
  24: { description: 'Kill Malachai.' },
  25: { description: 'Return to Highgate via Portal or logout.' },
  26: {
    description:
      'Exit into The Ascent, found in the upper right part of Highgate.',
  },
  27: {
    description: 'Interact with the resonator and take the Oriath Portal.',
  },
};
