...
const actTwo: Step = {
  1: { description: 'Enter the Riverways, taking the left exit.' },
  2: {
    description:
  ...
  9: { description: 'Follow either the left or right wall downwards.' },
  10: {
    description:
  ...
  15: { description: 'Take the Waypoint to the Forest Encampment.' },
  16: { description: 'Take the right exit this time, into the Old Fields.' },
  17: {
    description:
      'By this point, it is very likely that you will have out-leveled most or all of the zones on the right path. It is recommended for you to simply run through these zones to complete them as fast as possible, and only kill monsters to refill your Quicksilver Flask Quicksilver Flask(s).',
  },
  18: {
    description: 'Follow the road until you find the exit into the Crossroads.',
  },
  ...
  21: {
    description: 'Take the right path to find the exit to the Broken Bridge.',
  },
  22: { description: 'Follow the right wall until you encounter Kraityn.' },
  23: {
    description:
  ...
  25: { description: 'Take the Waypoint to the Crossroads.' },
  26: {
    description:
  ...
  31: { description: 'Speak with Greust to acquire the gem reward' },
  32: {
    description:
  ...
  34: { description: 'Exit into the Northern Forest.' },
  35: {
    description:
      'Head upwards through the Northern Forest until you find the exit into the Caverns. Do not enter the Dread Thicket.',
  },
  36: { description: 'Grab the Waypoint when you encounter it.' },
  37: { description: 'Locate the entrance to the Ancient Pyramid.' },
  38: {
    description:
      'Ascend the levels of the pyramid until you find the Pyramid Apex.',
  },
  39: {
    description: 'Slay the Vaal Oversoul and exit into the City of Sarn.',
  },
  40: {
    description:
