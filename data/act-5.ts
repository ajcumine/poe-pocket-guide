...
const actFive: Act = {
  ...
  3: { description: 'Talk to Lani to receive the ring reward.' },
  4: { description: 'Enter the Control Blocks.' },
  5: {
    description:
  ...
  8: { description: 'Find and enter the Templar Courts.' },
  9: {
    description:
  ...
  12: {
    description: 'Enter the Torched Courts and make your way through the area.',
  },
  13: {
    description:
  ...
  17: { description: 'Locate The Reliquary.' },
  18: {
    description:
      'Find each of Kitava’s Torments and return to town via logout or Portal.',
  },
  19: { description: 'Speak to Lani for the Book of Skill and jewel rewards.' },
  20: { description: 'Return to the Ruined Square via Waypoint.' },
  21: {
    description:
      'Enter the Cathedral Rooftop and make your way through the area.',
  },
  22: { description: 'Enter the Cathedral Apex and defeat Kitava.' },
  23: { description: 'Speak with Lily Roth and sail to Wraeclast.' },
};
